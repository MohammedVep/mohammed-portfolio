...
export const experienceData: Experience[] = [
  {
    ...
    description: [
      ...
      "I work with associates, process assistants and managers to solve issues with workflow, exceed productivity expectations and make sure customers orders are shipped out on time with correct items. With this experience, my ability to work under pressure, work with team, communicate and pay close attention to detail has been excellent.",
      "My long tenure with Amazon reflects consistency, reliability and strong commitment to operational excellence. I have successfully processed large volumes of customer orders while staying focused on quality, safety, and customer satisfaction.",
    ],
  },
];
